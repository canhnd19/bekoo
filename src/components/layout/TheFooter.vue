...
.layout-footer {
  @apply mx-auto mb-4 grid w-full max-w-7xl grid-cols-[350px_1fr];
  .style-text-primary {
...
.footer {
  background: linear-gradient(82.98deg, #00b5f1 33.22%, #00e0ff 135.46%);
  @apply flex h-16 w-full items-center justify-center;
}
</style>
